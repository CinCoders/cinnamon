...
export function HamburgerButton({
  ...
  return (
    ...
    >
      ...
      <span
        className={cn(
          "absolute left-0 top-0 h-px w-full bg-primary transition-all duration-200 ease-in-out",
      ...
      <span
        className={cn(
          "absolute left-0 top-1/2 h-px w-full -translate-y-1/2 bg-primary transition-all duration-200 ease-in-out",
          isOpen && "opacity-0"
        )}
      />
      {/* Bottom */}
      <span
        className={cn(
          "absolute left-0 bottom-0 h-px w-full bg-primary transition-all duration-200 ease-in-out",
