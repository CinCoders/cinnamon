...
export const testSystems: System[] = [
  {
    title: "Dashboard",
    IconComponent: () => <LayoutDashboard className={iconClass} />,
    description: "SIPAC Process Management System",
    href: "#",
  },
  {
    title: "User Management",
    IconComponent: () => <UserCog className={iconClass} />,
    description: "User Management System",
    href: "#",
  },
  {
    title: "Human Resources",
    IconComponent: () => <Users className={iconClass} />,
    description: "Human Resources Management System",
    href: "#",
  },
  {
    title: "Allocation",
    IconComponent: () => <Calendar className={iconClass} />,
    description: "Course Scheduling and Planning System",
    href: "#",
  },
  {
    title: "Graduate Selection",
    IconComponent: () => <UserCheck className={iconClass} />,
    description: "Graduate Admissions System",
    href: "#",
  },
  {
    title: "Input Analysis",
    IconComponent: () => <UserSearch className={iconClass} />,
    description: "Badge-based Input Analysis System",
    href: "#",
  },
  {
    title: "FrequenCIn",
    IconComponent: () => <ClipboardCheck className={iconClass} />,
    description: "Student Attendance System",
    href: "#",
  },
  {
    title: "Prints",
    IconComponent: () => <Printer className={iconClass} />,
    description: "Balance and Print Log Inquiry System",
    href: "#",
  },
  {
    title: "Research System",
    IconComponent: () => <Landmark className={iconClass} />,
    description: "Research Indicators Survey and Analysis System",
    href: "#",
  },
  {
    title: "SGA",
    IconComponent: () => <GraduationCap className={iconClass} />,
