  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge className="font-normal tabular-nums" size="lg" variant="outline">
        <HugeiconsIcon icon={AirplaneTakeOffIcon} strokeWidth={2} />
...
function toExportData(flights: Flight[]): TableExportData {
  return {
    headers: ["Flight", "Departure", "Arrival", "Destination", "Status", "Terminal", "Gate"],
